...
public class StatusManager {
    ...
    private static final File STATUS_DIRECTORY_WHATSAPP = new File(Environment.getExternalStorageDirectory() + File.separator + "WhatsApp/Media/.Statuses");
    private static final File STATUS_DIRECTORY_WHATSAPP_BUSINESS = new File(Environment.getExternalStorageDirectory() + File.separator + "WhatsApp Business/Media/.Statuses");
    ...
    private void genStatuses() {
        ...
        if (STATUS_DIRECTORY_WHATSAPP.exists()) {

            new Thread(new Runnable() {
                @Override
                public void run() {

                    File[] statusFiles = STATUS_DIRECTORY_WHATSAPP.listFiles();
